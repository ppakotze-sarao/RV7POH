...
Two fuel quantity indicators form part of the EFIS display and receive a resistive signal from float type fuel
probes mounted in the fuel tanks. Both are marked to indicate the appropriate fuel tank. These indicators only
register from a set quantity and NOT from full. As with all float type fuel gauges, these will tend to be inaccurate
when flight attitude is not level and during turbulence.
